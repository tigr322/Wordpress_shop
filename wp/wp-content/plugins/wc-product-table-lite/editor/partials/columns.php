<div class="wcpt-column-settings wcpt-toggle-column-expand" wcpt-controller="column_settings" wcpt-model-key="[]"
  ...
  <span class="wcpt-column-setttings__top-left">
    ...
    <input class="wcpt-column-name wcpt-diw--disabled" type="text" wcpt-model-key="name" placeholder="Column name" />
  </span>

  <!-- heading -->
  <div class="wcpt-tabs" wcpt-model-key="heading">
    <div class="wcpt-tab-triggers">
      <div class="wcpt-tab-trigger">Column heading</div>
      <div class="wcpt-tab-trigger">Column heading design</div>
    </div>
