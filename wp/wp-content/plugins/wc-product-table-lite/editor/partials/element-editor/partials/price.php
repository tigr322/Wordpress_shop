...
<div class="wcpt-editor-row-option">
  <label>
    ...
    <small>
      This option puts this 'Price' element in 3rd party plugin compatibility mode.
    </small>
  </label>
</div>
...
<div class="wcpt-editor-row-option" wcpt-panel-condition="prop" wcpt-condition-prop="use_default_template"
  ...
  <div class="wcpt-editor-row-option">
    ...
    <div wcpt-block-editor wcpt-be-add-element-partial="add-price-element" wcpt-model-key="template"></div>
  </div>
  ...
  <div class="wcpt-editor-row-option">
    ...
    <div wcpt-block-editor wcpt-be-add-element-partial="add-price-sale-element" wcpt-model-key="sale_template"></div>
  </div>
  ...
  <div class="wcpt-editor-row-option">
    ...
    <div wcpt-block-editor wcpt-be-add-element-partial="add-price-variable-element" wcpt-model-key="variable_template">
    </div>
  </div>
